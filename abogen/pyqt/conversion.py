...
class ConversionThread(QThread):
    ...
    def __init__(
        ...
        self.fix_nonstandard_punctuation = False
        self.separate_chapters_format = "wav"
        self.save_chunks_in_folder_name: str | None = None
        self.subtitle_format: str = "srt"
        self.chapter_count = 0
        self.file_size_str: str = ""
        self.replace_single_newlines: bool = False
        self.use_silent_gaps: bool = False
        self.subtitle_speed_method: str = ""
        self.use_mlx_backend: bool = False
        self.mlx_quantization: str = ""
        self.word_substitutions_enabled: bool = False
        self.word_substitutions_list: Any = ""
        self.case_sensitive_substitutions: bool = False
        self.replace_all_caps: bool = False
                ...
                try:
                    ...
                    if is_mlx_available():
                        ...
                        if (
                            ...
                            mlx_model = load(mlx_quant.model_path)
    ...
    def _process_subtitle_tokens(
        ...
        Args:
            tokens_with_timestamps (list[dict[str, Any]]): List of token dictionaries with timestamps.
            subtitle_entries (list[tuple[float, float, str]]): List to append subtitle tuples to.
            max_subtitle_words (int): Maximum words allowed per subtitle entry.
